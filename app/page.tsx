...
export const metadata: Metadata = {
  title: "Dealer and Facebook Listings for Foster’s Car Search — September 17, 2026",
  ...
  return (
    <main>
      <header className="hero">
        <nav><span className="wordmark">FOSTER’S</span><span className="date">THURSDAY · SEP 17, 2026</span></nav>
      ...
      <section className="coverage">
        ...
        <p className="coverage-note">This run rechecked every active listing. A Ford Fusion screened earlier now has a verified individual dealer page and exact photo, so it joins the dealer ranking; it is not a new-today find. No first-time qualifying cars survived the checks. Dealer Google reviews were verified again. No stock or substitute images were used.</p>
      </section>
      ...
      <footer><p>Fresh search completed September 17, 2026. Dealer and Facebook inventory and history are stored separately.</p><p>Availability changes quickly. Verify the listing, VIN, title and condition again before traveling.</p></footer>
    </main>
  );
}
