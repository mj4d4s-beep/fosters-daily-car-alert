...
export const metadata: Metadata = {
  title: "Dealer and Facebook Listings for Foster’s Car Search — September 8, 2026",
  ...
  return (
    <main>
      <header className="hero">
        <nav><span className="wordmark">FOSTER’S</span><span className="date">TUESDAY · SEP 8, 2026</span></nav>
      ...
      <section className="coverage">
        ...
        <p className="coverage-note">This run reverified every active listing and found no qualifying dealer additions. One newly listed private-party Honda Fit had a live individual page and exact-car photos, so it entered the Facebook ranking; the still-live Yaris moved to fallback because its safety equipment is unverified and the Fit has stronger verified core crash results. No stock or substitute images were used.</p>
      </section>
      ...
      <footer><p>Fresh search completed September 8, 2026. Dealer and Facebook inventory and history are stored separately.</p><p>Availability changes quickly. Verify the listing, VIN, title and condition again before traveling.</p></footer>
    </main>
  );
}
