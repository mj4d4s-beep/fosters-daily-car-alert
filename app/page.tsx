...
export const metadata: Metadata = {
  title: "Dealer and Facebook Listings for Foster’s Car Search — September 4, 2026",
  ...
  return (
    <main>
      <header className="hero">
        <nav><span className="wordmark">FOSTER’S</span><span className="date">FRIDAY · SEP 4, 2026</span></nav>
      ...
      <section className="coverage">
        ...
        <p className="coverage-note">This run reverified every active listing and added only leads with live individual pages, exact-car photos and enough information to assess. One unavailable Facebook car was removed; a misclassified dealer, a warning-light car and a very-high-mileage low-transparency car were excluded. No stock or substitute images were used.</p>
      </section>
      ...
      <footer><p>Fresh search completed September 4, 2026. Dealer and Facebook inventory and history are stored separately.</p><p>Availability changes quickly. Verify the listing, VIN, title and condition again before traveling.</p></footer>
    </main>
  );
}
