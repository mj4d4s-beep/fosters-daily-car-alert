...
export const metadata: Metadata = {
  title: "Dealer and Facebook Listings for Foster’s Car Search — September 7, 2026",
  ...
  return (
    <main>
      <header className="hero">
        <nav><span className="wordmark">FOSTER’S</span><span className="date">MONDAY · SEP 7, 2026</span></nav>
      ...
      <section className="coverage">
        ...
        <p className="coverage-note">This run reverified every active listing, removed a now-pending Facebook car, updated one price drop and added one private-party Jetta with a live individual page and exact-car photos. A Corolla needing a wheel bearing, a stale replacement-engine Mirage, a weakly documented Forester and a low-mileage Mazda2 with unverified odometer history did not make the top eight. No stock or substitute images were used.</p>
      </section>
      ...
      <footer><p>Fresh search completed September 7, 2026. Dealer and Facebook inventory and history are stored separately.</p><p>Availability changes quickly. Verify the listing, VIN, title and condition again before traveling.</p></footer>
    </main>
  );
}
