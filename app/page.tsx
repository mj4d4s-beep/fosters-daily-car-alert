...
export const metadata: Metadata = {
  title: "Dealer and Facebook Listings for Foster’s Car Search — September 18, 2026",
  ...
  return (
    <main>
      <header className="hero">
        <nav><span className="wordmark">FOSTER’S</span><span className="date">FRIDAY · SEP 18, 2026</span></nav>
      ...
      <section className="coverage">
        ...
        <p className="coverage-note">This run rechecked every active listing and each dealer’s Google reviews. Newly screened Facebook cars with an ABS fault, unspecified repairs, weak history or dealer classification were not added. No first-time qualifying cars survived the checks. No stock or substitute images were used.</p>
      </section>
      ...
      <footer><p>Fresh search completed September 18, 2026. Dealer and Facebook inventory and history are stored separately.</p><p>Availability changes quickly. Verify the listing, VIN, title and condition again before traveling.</p></footer>
    </main>
  );
}
