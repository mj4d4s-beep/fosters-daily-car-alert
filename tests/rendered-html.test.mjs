...
test("server-renders the complete daily alert", async () => {
  ...
  assert.match(html, /Dealer and Facebook Listings for Foster’s Car Search — September 14, 2026/);
  ...
  assert.equal((visibleMarkup.match(/Read Google reviews/g) ?? []).length, 10);
